...
namespace KGPU
{
    Metal3MeshPipeline::Metal3MeshPipeline(Metal3Device* device, MeshPipelineDesc desc)
    {
        mDesc = desc;
        ...
        mPipelineState = [device->GetMTLDevice() newRenderPipelineStateWithMeshDescriptor:pipelineDescriptor
                                                 ...
                                                 reflection: nil
                                                 error: nil];
        KD_ASSERT_EQ(mPipelineState, "Failed to create Metal3 mesh pipeline!");

        KD_WHATEVER("Created Metal3 mesh pipeline");
    }

    Metal3MeshPipeline::~Metal3MeshPipeline()
    {
