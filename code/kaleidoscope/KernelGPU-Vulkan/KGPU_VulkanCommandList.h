...
namespace KGPU
{
    ...
    private:
        static VkPipelineStageFlags2 TranslatePipelineStageToVk(PipelineStage stage);
        static VkAccessFlags2 TranslateAccessFlagsToVk(ResourceAccess access);
        static VkImageLayout TranslateLayoutToVk(ResourceLayout layout);
