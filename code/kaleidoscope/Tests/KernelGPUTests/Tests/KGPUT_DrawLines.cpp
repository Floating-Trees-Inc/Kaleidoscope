...
namespace KGPUT
{
    class DrawLines : public BaseTest
    {
    public:
        DrawLines()
        {
        ...
        void Execute() override
        {
            ...
            mCommandList->SetGraphicsPipeline(Gfx::ShaderManager::GetGraphics("data/kd/shaders/tests/draw_lines.kds"));
            mCommandList->Draw(4, 1, 0, 0);
...
DEFINE_RHI_TEST(DrawLines) {
    KGPUT::DrawLines test;
    return test.Run();
}
