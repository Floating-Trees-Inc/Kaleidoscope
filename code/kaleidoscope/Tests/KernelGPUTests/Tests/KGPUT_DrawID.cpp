...
namespace KGPUT
{
    ...
    public:
        ...
        void Execute() override
        {
            ...
            uint drawCommands[] = { 0, 3, 1, 0, 0,    // Draw 1
                                    1, 3, 1, 0, 0  }; // Draw 2
            Gfx::Uploader::EnqueueBufferUpload(drawCommands, sizeof(uint) * 10, mIndirectBuffer, mCommandList);
